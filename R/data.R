...
#'  \item{news}{Seemingly random tidbits of information about the comic (e.g. backstory, contributors, merch links.) May contain HTML for later comics but is blank for the first 10.}
#'  \item{safe_title}{Title of the comic. I'm not sure what's so safe about it...}
#'  \item{transcript}{Transcription of the text in the comic image}
#'  \item{alt}{Alt text for image in the web browser}
#'  \item{image}{URL linking to the comic image}
